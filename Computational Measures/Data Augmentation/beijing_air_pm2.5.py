...
while (i<3):
  ...
  metadata=add_metadata("Transformers: Training without feat_imp", i, "Beijing Air", 100, mse_.item())
...
while(i<3):
  model = TransformerRegressor(input_dim, d_model, nhead, num_encoder_layers, dim_feedforward, output_dim)
  model.to(device)
  new_data=create_dataset(beijing_air_data, shap_values)
  ...
  print("MSE: ", mse_)
  mse_new.append(mse_)
  metadata=add_metadata("Transformers: Training with feat_imp", i, "Beijing Air", 100, mse_.item())
