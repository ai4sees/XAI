...
if __name__ == "__main__":
  ...
  #Train RNN Model without feature importances
    ...
    metadata = add_metadata("RNN", "not included", epochs, mse.item())
  ...
  #train model with feature importances
    ...
    metadata = add_metadata("RNN", "included", epochs, mse.item())
    ...
    plt.legend()
    plt.savefig("loss_curves_rnn_aug.png")
  ...
  if MODEL == "trans":
    ...
    metadata = add_metadata("Transformers", "not included", epochs, mse.item())
    ...
    metadata = add_metadata("Transformers", "included", epochs, mse.item())
    ...
    plt.legend()
    plt.ylim(0, 1)
    plt.savefig("loss_curves_trans_aug.jpg")
